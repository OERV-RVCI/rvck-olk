...
static inline int rmi_ccal_delegate_range(unsigned long start_addr,
					  unsigned long size)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_DELEGATE_RANGE,
		start_addr, size
	};
...
static inline int rmi_ccal_delegate_io_range(unsigned long start_addr,
					     unsigned long size)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_IO_DELEGATE_RANGE,
		start_addr, size
	};
...
static inline int rmi_ccal_undelegate_range(unsigned long start_addr,
					    unsigned long size)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_UNDELEGATE_RANGE,
		start_addr, size
	};
...
static inline int rmi_ccal_undelegate_io_range(unsigned long start_addr,
					       unsigned long size)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_IO_UNDELEGATE_RANGE,
		start_addr, size
	};
...
static inline int rmi_ccal_block_create(unsigned long rd, unsigned long data,
					unsigned long ipa, unsigned long src,
					unsigned long flags)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_BLOCK_DATA_CREATE_LVL2,
...
static inline int rmi_ccal_block_create_unknown(unsigned long rd,
						unsigned long data,
						unsigned long ipa)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_BLOCK_DATA_CREATE_UNKNOWN_LVL2,
		rd, data, ipa
	};
...
static inline int rmi_ccal_data_destroy(unsigned long rd, unsigned long ipa,
					unsigned long *pa, unsigned long *size,
					unsigned long *granule_type,
					unsigned long *top_ipa)
{
	struct arm_smccc_1_2_regs regs = {
		SMC_RMI_HISI_EXT, CCAL_DATA_DESTROY,
		rd, ipa
	};
