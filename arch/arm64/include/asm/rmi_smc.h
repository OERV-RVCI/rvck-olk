...
enum hisi_ext_cmd {
	CCAL_DELEGATE_RANGE = 0,
	CCAL_UNDELEGATE_RANGE,
	CCAL_IO_DELEGATE_RANGE,
	CCAL_IO_UNDELEGATE_RANGE,
	CCAL_BLOCK_DATA_CREATE_LVL2,
	CCAL_BLOCK_DATA_CREATE_UNKNOWN_LVL2,
	CCAL_DATA_DESTROY,
};
